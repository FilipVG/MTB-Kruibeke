...
export const config = {
  matcher: [
    // Sla statische bestanden, afbeeldingen en publieke API's over — geen auth nodig
    '/((?!_next/static|_next/image|favicon.ico|api/calendar\\.ics|api/cron|.*\\.(?:svg|png|jpg|jpeg|gif|webp)$).*)',
  ],
};
